  ...
  if($er==0){
    ...
    if ($result_email1->num_rows == 1){
        while($row = $result_email1->fetch_assoc()) {
            ...
            $toEmail = $row['email'];
            $subject = "Password Recovery from DemandKar";
            $body = "Greetings! The Password for your Account on DemandKar is '$pass'. Kindly Login using this Password to continue using our Application and Make Sure to Remember your Password! :)";
            ...
            <form data-aos="zoom-in" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
             <div class="row justify-content-center logo">
              ...
              <div class="form-group">
                  <h3>Enter the Registered Email ID to Receive the Password in your Mail!</h3>
